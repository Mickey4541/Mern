...
const CreateTask = () => {
    ...
    const submitHandler = (e) => {
        ...
        data.forEach(function(e){//foreach loop jo array maa lagxa ra hamile json.parse garera data lai array of object maa lagi sakeko xa mathi.
            // console.log(e.name);
            if(assignTo == e.name){
...
//yo page maa gareko submit handler value set gareko aani on change wala sabai two way binding ho.
  return (
    ...
    <form onSubmit={(e)=>{submitHandler(e)}} className='flex flex-wrap w-full items-start justify-between'>
        <div className='w-1/2'>
            ...
            <div>
                ...
                <input value={assignTo} onChange={(e)=>{setAssignTo(e.target.value)}} className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='emloyee name' />
            </div>
            <div>
